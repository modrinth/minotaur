...
| environment      | false    | The environments the version can be used in. See [the blog post](https://modrinth.com/news/article/new-environments/#new-system) for more information |                                              |
