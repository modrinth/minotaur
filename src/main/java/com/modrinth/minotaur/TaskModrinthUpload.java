...
public class TaskModrinthUpload extends DefaultTask {
     ...
     * what you're doing. Its main use case is for debug, development, or advanced user
     * configurations.
     */
    public String apiURL = "https://api.modrinth.com/v2";
    ...
    public void apply() {
        try {
            ...
            if (file == null || !file.exists()) {
                ...
                throw new GradleException("The upload file is missing or null. " + this.uploadFile);
            }
